...
var code_executiveCols = [
	...
	,{header: "ชื่อย่อคำนำหน้า", width: 100, sortable: false, dataIndex: "shortpre", editor: new Ext.form.NumberField({allowBlank: false, maxLength: 5 })}
	,{header: "คำนำหน้า", width: 100, sortable: false, dataIndex: "longpre", editor: new Ext.form.NumberField({allowBlank: false})}
	,{header: "ตำแหน่ง", width: 100, sortable: false, dataIndex: "exname", editor: new Ext.form.NumberField({allowBlank: false})}
	,{header: "รหัสแทน", width: 100, sortable: false, dataIndex: "stdcode", editor: new Ext.form.NumberField({allowBlank: false})}
