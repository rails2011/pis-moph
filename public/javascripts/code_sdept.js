...
var code_sdeptCols = [
        ...
        ,{header: "รหัส", width: 50, sortable: false, dataIndex: "sdcode", editor: new Ext.form.NumberField({allowBlank: false, minLen
gth: 5 , maxLength: 5 })}
        ...
        ,{header: "รหัสsdt", width: 50, sortable: false, dataIndex: "sdtcode", editor: new Ext.form.NumberField({allowBlank: false})}
        ,{header: "รหัสsg", width: 50, sortable: false, dataIndex: "sdgcode", editor: new Ext.form.NumberField({allowBlank: false})}
        ,{header: "รหัสacode", width: 50, sortable: false, dataIndex: "acode", editor: new Ext.form.NumberField({allowBlank: false})}
        ,{header: "รหัสtrl", width: 50, sortable: false, dataIndex: "trlcode", editor: new Ext.form.NumberField({allowBlank: false})}
        ...
        ,{header: "รหัสl code", width: 50, sortable: false, dataIndex: "lcode", editor: new Ext.form.NumberField({allowBlank: false})}
        ,{header: "สถานะ bkd", width: 50, sortable: false, dataIndex: "flagbkd", editor: new Ext.form.TextField({allowBlank: false, mi
nLength: 1 , maxLength: 1 })}
