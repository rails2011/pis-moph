...
var code_updateCols = [
        ...
        ,{header: "รหัส", width: 100, sortable: false, dataIndex: "updcode", editor: new Ext.form.NumberField({allowBlank: false, minLength: 4 , maxLength: 4 })}
...
var code_updateProxy = new Ext.data.HttpProxy({
   api : {
           read         : '/code_update/read'
           ,create      : '/code_update/create'
           ,update      : '/code_update/update'
           ,destroy     : '/code_update/delete'
   }
});
							...
							items   : [
									{
											...
											,handler        : function() {
													...
													form.setAttribute("action", "/code_update/report?format=xls");
											...
											,handler : function() {
													...
													var form = document.createElement("form");
													form.setAttribute("method", "post");
													form.setAttribute("action", "/code_update/report?format=pdf");
													form.setAttribute("target", "_blank");
													var hiddenField = document.createElement("input");
													hiddenField.setAttribute("name", "data");
													hiddenField.setAttribute("value", data);
